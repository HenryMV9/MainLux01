  ...
  document.getElementById('ordersBody').innerHTML = filtered.length
    ? filtered.map(o => `
        <tr>
          ...
          <td style="font-size:0.76rem;color:#888">${o.customer_email}</td>
...
function viewOrder(id) {
  ...
  document.getElementById('modalContent').innerHTML = `
    <div class="modal-field-group">
      <div class="modal-field"><label>Customer</label><p>${o.customer_name}</p></div>
      <div class="modal-field"><label>Phone</label><p>${o.customer_phone}</p></div>
      <div class="modal-field"><label>Email</label><p style="font-size:0.8rem">${o.customer_email}</p></div>
      <div class="modal-field"><label>Status</label><p><span class="badge badge-${o.status}">${o.status}</span></p></div>
    </div>
    <div style="margin-bottom:18px">
      ...
      <p style="font-size:0.84rem">${o.shipping_address}</p>
    </div>
